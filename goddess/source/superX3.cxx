...
superX3::superX3(std::string serial_Num, unsigned short sector_, unsigned short depth_, bool up_Stream, SolidVector position) :
 ...
 * \The numbering of the contact is
...
void superX3::SetStripPosCalibPars(int strip, std::vector<float> pars)
{
	...
	if (pars.size() != 2)
	{
		std::cerr << "ERROR: Number of calibration parameters specified for SX3 Position calibration incorrect (Expected 2, got " << pars.size() << ")"
				<< std::endl;
	}
